                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="{{ asset('/') }}admin/assets/images/rajat.jpg" alt="Header Avatar">
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">Rajat Saha</span>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarApps">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{ route('add.category') }}" class="nav-link" data-key="t-calendar"> Add Category </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('manage.category') }}" class="nav-link" data-key="t-chat"> Manage Category </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
