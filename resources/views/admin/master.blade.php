...
<!-- Mirrored from themesbrand.com/velzon/html/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 23 Mar 2023 15:37:17 GMT -->
                        ...
                        <div class="dropdown ms-1 topbar-head-dropdown header-item">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="{{ asset('/') }}admin/assets/images/flags/italy.svg"
                                        alt="user-image" class="me-2 rounded" height="18">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="{{ asset('/') }}admin/assets/images/flags/russia.svg"
                                        alt="user-image" class="me-2 rounded" height="18">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="{{ asset('/') }}admin/assets/images/flags/china.svg"
                                        alt="user-image" class="me-2 rounded" height="18">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="{{ asset('/') }}admin/assets/images/flags/french.svg"
                                        alt="user-image" class="me-2 rounded" height="18">
                        ...
                        <div class="dropdown ms-sm-3 header-item topbar-user">
                            <button type="button" class="btn" id="page-header-user-dropdown"
                                ...
                                <span class="d-flex align-items-center">
                                    <img class="rounded-circle header-profile-user"
                                        src="{{ asset('/') }}admin/assets/images/rajat.jpg" alt="Header Avatar">
                                    <span class="text-start ms-xl-2">
                                        <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">Rajat
                                            Saha</span>
                                        <span
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item" href="auth-logout-basic.html"><i
                                        ...
                                        class="align-middle" data-key="t-logout" onclick="event.preventDefault(); document.getElementById('logoutForm').submit();">Logout</span></a>
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarApps" data-bs-toggle="collapse"
                                ...
                                <i class="ri-apps-2-line"></i> <span data-key="t-apps">Category Module</span>
                            </a>
                            <div class="collapse menu-dropdown" id="sidebarApps">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{ route('add.category') }}" class="nav-link"
                                            data-key="t-calendar"> Add Category </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('manage.category') }}" class="nav-link" data-key="t-chat">
                                            Manage Category </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarLayouts">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{ route('add.subcategory') }}" target="_blank" class="nav-link"
                                            data-key="t-horizontal">Add Sub category</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{ route('manage.subcategory') }}" target="_blank" class="nav-link"
                                            data-key="t-detached">manage Sub Category</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                                ...
                                <div class="card h-100 rounded-0">
                                    <div class="card-body p-0">
                                        ...
                                        <div class="card sidebar-alert bg-light border-0 text-center mx-4 mb-0 mt-3">
                                            <div class="card-body">
                                                <img src="{{ asset('/') }}admin/assets/images/giftbox.png"
                                                    alt="">
                                                <div class="mt-4">
                        ...
                        <div class="d-flex gap-2 flex-wrap img-switch">
                            ...
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-01">
                                    <img src="{{ asset('/') }}admin/assets/images/sidebar/img-1.jpg"
                            ...
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-02">
                                    <img src="{{ asset('/') }}admin/assets/images/sidebar/img-2.jpg"
                                        alt="" class="avatar-md w-auto object-cover">
                                </label>
                            </div>
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-03">
                                    <img src="{{ asset('/') }}admin/assets/images/sidebar/img-3.jpg"
                                        alt="" class="avatar-md w-auto object-cover">
                                </label>
                            </div>
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-04">
                                    <img src="{{ asset('/') }}admin/assets/images/sidebar/img-4.jpg"
                                        alt="" class="avatar-md w-auto object-cover">
                                </label>
                            </div>
                        </div>
...
<!-- Mirrored from themesbrand.com/velzon/html/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 23 Mar 2023 15:38:15 GMT -->
