...
<!-- Mirrored from tunatheme.com/tf/html/spero-preview/spero/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Mar 2023 04:14:28 GMT -->
    ...
    <div class="body-wrapper">
                                    ...
                                    <div class="ltn__main-menu">
                                        ...
                                        <li class="menu-icon"><a href="#">Pages</a>
                                            <ul class="mega-menu">
                                                ...
                                                <li><a href="shop.html"><img src="{{ asset('/') }}website/assets/img/banner/menu-banner-1.jpg" alt="#"></a>
                                                </li>
                                            </ul>
                                        </li> --}}
                ...
                <div class="mini-cart-product-area ltn__scrollbar">
                    <div class="mini-cart-item clearfix">
                        <div class="mini-cart-img">
                            <a href="#"><img src="{{ asset('/') }}website/assets/img/product/1.png"
                                    alt="Image"></a>
                    ...
                    <div class="mini-cart-item clearfix">
                        <div class="mini-cart-img">
                            <a href="#"><img src="{{ asset('/') }}website/assets/img/product/2.png"
                                    alt="Image"></a>
                            <span class="mini-cart-item-delete"><i class="icon-cancel"></i></span>
                        </div>
                        <div class="mini-cart-info">
                    ...
                    <div class="mini-cart-item clearfix">
                        <div class="mini-cart-img">
                            <a href="#"><img src="{{ asset('/') }}website/assets/img/product/3.png"
                                    alt="Image"></a>
                            <span class="mini-cart-item-delete"><i class="icon-cancel"></i></span>
                        </div>
                        <div class="mini-cart-info">
                    ...
                    <div class="mini-cart-item clearfix">
                        <div class="mini-cart-img">
                            <a href="#"><img src="{{ asset('/') }}website/assets/img/product/4.png"
                                    alt="Image"></a>
                            <span class="mini-cart-item-delete"><i class="icon-cancel"></i></span>
                        </div>
                        <div class="mini-cart-info">
        ...
        <div id="ltn__utilize-mobile-menu" class="ltn__utilize ltn__utilize-mobile-menu">
            <div class="ltn__utilize-menu-inner ltn__scrollbar">
                <div class="ltn__utilize-menu-head">
                    <div class="site-logo">
                        <a href="index.html"><img src="{{ asset('/') }}website/assets/img/logo.png"
                                alt="Logo"></a>
                    </div>
                    <button class="ltn__utilize-close">×</button>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-md-6 col-sm-6 col-12">
                            <div class="footer-widget footer-about-widget">
                                <div class="footer-logo">
                                    <div class="site-logo">
                                        <img src="{{ asset('/') }}website/assets/img/logo-2.png" alt="Logo">
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-3 col-md-6 col-sm-12 col-12">
                            <div class="footer-widget footer-newsletter-widget">
                                ...
                                <img src="{{ asset('/') }}website/assets/img/icons/payment-4.png"
                                    alt="Payment Image">
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-12">
                                            <div class="modal-product-img">
                                                <img src="{{ asset('/') }}website/assets/img/product/4.png"
                                                    alt="#">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-12">
                            ...
                            <div class="ltn__quick-view-modal-inner">
                                <div class="modal-product-item">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="modal-product-img">
                                                <img src="{{ asset('/') }}website/assets/img/product/1.png"
                                                    alt="#">
                                            </div>
                                            <div class="modal-product-info">
                                            ...
                                            <div class="additional-info d-none">
                                                ...
                                                <div class="payment-method">
                                                    <img src="{{ asset('/') }}website/assets/img/icons/payment.png"
                                                        alt="#">
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="ltn__quick-view-modal-inner">
                                <div class="modal-product-item">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="modal-product-img">
                                                <img src="{{ asset('/') }}website/assets/img/product/7.png"
                                                    alt="#">
                                            </div>
                                            <div class="modal-product-info">
                                                <h5><a href="product-details.html">Brake Conversion Kit</a></h5>
...
<!-- Mirrored from tunatheme.com/tf/html/spero-preview/spero/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Mar 2023 04:14:53 GMT -->
