...
@section('body')
                ...
                <div class="col-lg-6 align-self-center">
                    <div class="about-us-img-wrap about-img-left">
                        <div class="ltn__video-img ltn__video-img-before-none ltn__animation-pulse2">
                            <img src="{{ asset('/') }}website/assets/img/others/18.png" alt="video popup bg image">
    ...
    <div class="ltn__call-to-action-area ltn__call-to-action-4 bg-image" data-bg="{{ asset('/') }}website/assets/img/bg/36.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="call-to-action-inner call-to-action-inner-4 text-center--- pt-115 pb-120">
                        <div class="section-title-area ltn__section-title-2">
                            <h6 class="section-subtitle ltn__secondary-color"><a href="tel:+123456789">123-456-7890/call</a>
                            </h6>
                    ...
                    <div class="ltn__call-to-4-img-2">
                        <img src="{{ asset('/') }}website/assets/img/bg/35.png" alt="#">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="ltn__video-popup-area ltn__video-popup-margin---">
        <div class="ltn__video-bg-img ltn__video-popup-height-600--- bg-overlay-black-30 bg-image bg-fixed ltn__animation-pulse1"
            data-bg="{{ asset('/') }}website/assets/img/bg/37.jpg">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="call-to-action-inner call-to-action-inner-6 ltn__secondary-bg text-center---">
                        ...
                        <div class="btn-wrapper">
                            <a class="btn btn-effect-3 btn-white" href="contact.html">Get A Quote <i
                                    class="icon-next"></i></a>
                        </div>
                    </div>
                </div>
