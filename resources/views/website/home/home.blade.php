            ...
            <div class="row">
                <div class="col-lg-6 align-self-center">
                    <div class="about-us-img-wrap about-img-left">
                        <img src="{{ asset('/') }}website/assets/img/others/17.png" alt="About Us Image">
                    </div>
                </div>
                <div class="col-lg-6 align-self-center">
        ...
        <div class="container">
            ...
            <div class="row ltn__image-slider-3-active slick-arrow-1 slick-arrow-1-inner---">
                <div class="col-lg-12">
                    <div class="ltn__img-slide-item-3 ltn__img-slide-item-3-2">
                        <a href="portfolio-details.html">
                            <img src="{{ asset('/') }}website/assets/img/product-4/1.jpg" alt="Image">
                        </a>
                ...
                <div class="col-lg-12">
                    <div class="ltn__img-slide-item-3 ltn__img-slide-item-3-2">
                        <a href="portfolio-details.html">
                            <img src="{{ asset('/') }}website/assets/img/product-4/2.jpg" alt="Image">
                        </a>
                        <div class="ltn__img-slide-info">
                            <div class="ltn__img-slide-info-brief">
                                <h6>Construction</h6>
                ...
                <div class="col-lg-12">
                    <div class="ltn__img-slide-item-3 ltn__img-slide-item-3-2">
                        <a href="portfolio-details.html">
                            <img src="{{ asset('/') }}website/assets/img/product-4/3.jpg" alt="Image">
                        </a>
                        <div class="ltn__img-slide-info">
                            <div class="ltn__img-slide-info-brief">
                                <h6>Construction</h6>
